define('userflnxbottomsheetController',{
    ...
    onViewCreated: function() {
        ...
        var txtFldDate = new kony.ui.TextBox2({
            ...
            "maxTextLength": null,
            "placeholder": "MM/YY",
            "restrictCharactersSet": "~`!@#$%^&*()_-+=;:'\"[{}]\\|,<>.?xqwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM",
            "secureTextEntry": false,
            "skin": "txtfieldskin",
            "textInputMode": constants.TEXTBOX_INPUT_MODE_ANY,
            "top": "123dp",
...
define('flnxbottomsheetControllerActions',{
    /*
...
define('flnxbottomsheetController',["userflnxbottomsheetController","flnxbottomsheetControllerActions"],
		function(){
